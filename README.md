  ...
  <form id='form_parameters'>
    ...
    <div class=mainBox>
      ...
      <div class=section>
        ...
        <input type='text' id='pressure_altitude' value='0' onblur=calc_power_available()>
        <br><br>
        <label for='temperature' class=label>Temperature<label> <span class=detail>(°C)</span>
        <div class=row>
          <div class=column style='width: 20%'>
            <input type='text' size='3' id='temperature_display' class=range_number style='border-bottom: none'  disabled>
          </div>
        ...
        <div class=row>
          <div class=column style='width: 20%'>
            <input type='text' size='3' id='wind_display' disabled style='border-bottom: none'>
          </div>
          <div class=column style='width: 80%'>
      ...
      <div class=section>
        ...
        <div class=row>
          <div class=column>
            <input type='text' disabled id='aircraft_weight' style='border-bottom: none'>
          </div>
          <div class=column>
        ...
        <input type='text' min='0' max='2000' value='0' id='load' onblur='calc_auw()'><br>
        <br>
        <label for='fuel' class=label>Fuel</label> <span class=detail>(kg)</span><br>
        <div class=row>
          <div class=column style='width: 20%'>
            <input type='text' size='3' id='fuel_display' disabled style='border-bottom: none'>
          </div>
          <div class=column style='width: 80%'>
        ...
        <input id='auw' type='text' disabled style='border-bottom: none'>
      </div>
